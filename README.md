...
This is a central place for my personal notes I have been taking while studying Japanese. I have chosen to make these notes public and share them as I am a strong believer that learning and the resources required for learning should be as accessible as possible to as many people as possible. In the event that my notes may be helpful to anyone else learning Japanese, then sharing them has been worthwhile.

> [!CAUTION]
> Everything here is subject to my understanding of Japanese and could very well be wrong. Take this all with a grain of salt.

## Getting Started

If you are just getting started with Japanese read this section first otherwise you probably want to skip this section.

Learning Japanese for me is still very much a work in progress, however it has easily been one of the most difficult, rewarding and worthwhile things I have done in life. This section is my subjective opinion on a decent way to start learning along with some resources I have found to be very beneficial. I think its also important to note that everybody learns differently and you should try different approaches to find what is best for you, what I have here is what worked for me.
...
| Section                                  | Description                                                                         |
| ---------------------------------------- | ----------------------------------------------------------------------------------- |
| [Kana Charts](./kana/kana.md)            | Hiragana and Katakana charts for quick reference                                    |
...
A collection of resources I would reccomend checking out
...
| [Kotatsu-Redo](https://github.com/Kotatsu-Redo/Kotatsu-Redo)                           | Good android app for reading manga in Japanese                                                                   |
